...
Allow the user to permanently delete an existing subject.
...
1. The user clicks the **"Delete Subject"** button.
2. The system displays a confirmation dialog.
3. The system informs the user that all tasks associated with the selected subject will also be permanently deleted.
